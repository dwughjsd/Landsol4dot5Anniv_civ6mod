...
INSERT INTO TraitModifiers (TraitType, ModifierId)							--"ModifierId" = "AQUA_FLOCK_ADJUST_CITY_#"
SELECT 'TRAIT_LEADER_SUMMER_AQUA_FLOCK', 'AQUA_FLOCK_ADJUST_CITY_' || Stack
...
SELECT	'AQUA_FLOCK_ADJUST_CITY_' || Stack,
...
SELECT	'AQUA_FLOCK_ADJUST_CITY_' || '_MODIFIER',
		'MODIFIER_SINGLE_CITY_ADJUST_CITY_YIELD_MODIFIER'
FROM	AquaFlockParameters
WHERE	Stack = 1;

INSERT INTO ModifierArguments (ModifierId, Name, Value)						--"ModifierId" = "AQUA_FLOCK_ADJUST_CITY_MODIFIER"
SELECT	'AQUA_FLOCK_ADJUST_CITY_' || Stack,
		'ModifierId', 'AQUA_FLOCK_ADJUST_CITY_' || '_MODIFIER'
FROM	AquaFlockParameters;

INSERT INTO ModifierArguments (ModifierId, Name, Value)						--Type YieldType here
SELECT	'AQUA_FLOCK_ADJUST_CITY_' || '_MODIFIER',
		'YieldType', 'YIELD_SCIENCE,YIELD_CULTURE,YIELD_PRODUCTION'
FROM	AquaFlockParameters
WHERE	Stack = 1;

INSERT INTO ModifierArguments (ModifierId, Name, Value)						--Yield Amount
SELECT	'AQUA_FLOCK_ADJUST_CITY_' || '_MODIFIER', 'Amount', '3,3,3'
FROM	AquaFlockParameters
WHERE	Stack = 1;
